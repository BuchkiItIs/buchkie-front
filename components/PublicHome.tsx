...
export default function PublicHome() {
  return (
    ...
    >
      ...
      <Triangle className="absolute top-52 left-4 w-4 h-4 xl:w-8 xl:h-8" />
      ...
      <Triangle className="absolute bottom-2 sm:bottom-38 lg:bottom-24 right-4 w-2 h-2 lg:right-32 xl:w-8 xl:h-8 xl:bottom-14" />
      ...
      <SkeletonCard className="bottom-72 left-2 w-56 xl:-rotate-2 rotate-12 sm:-top-10 sm:left-50 lg:w-50 lg:top-auto lg:bottom-5 xl:w-100 xl:top-auto xl:bottom-10">
      ...
      <SkeletonCard className="bottom-24 sm:-bottom-10 right-2 w-54 -rotate-12 md:-bottom-35 md:-right-12 lg:right-0 xl:-right-12 xl:bottom-30 md:w-80 lg:w-60 xl:w-110">
